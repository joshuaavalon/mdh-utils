...
export class ExtendedRecordService<C extends Collections> extends RecordService<CollectionResponses[C]> {
  ...
  public async findFirst(filter: string, opts?: Omit<RecordListOptions, "filter">): Promise<CollectionResponses[C] | undefined> {
  ...
  public async first(strings: TemplateStringsArray, ...values: unknown[]): Promise<CollectionResponses[C] | undefined> {
